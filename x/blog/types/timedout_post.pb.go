...
// source: planet/blog/timedout_post.proto
...
type TimedoutPost struct {
	...
	ExistingPostID string `protobuf:"bytes,5,opt,name=existingPostID,proto3" json:"existingPostID,omitempty"`
}
...
func (*TimedoutPost) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfeb3bcc1b7eff8d, []int{0}
}
...
func (m *TimedoutPost) GetExistingPostID() string {
	if m != nil {
		return m.ExistingPostID
	}
	return ""
}
...
func init() { proto.RegisterFile("planet/blog/timedout_post.proto", fileDescriptor_dfeb3bcc1b7eff8d) }

var fileDescriptor_dfeb3bcc1b7eff8d = []byte{
	// 205 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TimedoutPost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ExistingPostID) > 0 {
		i -= len(m.ExistingPostID)
		copy(dAtA[i:], m.ExistingPostID)
		i = encodeVarintTimedoutPost(dAtA, i, uint64(len(m.ExistingPostID)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Creator) > 0 {
...
func (m *TimedoutPost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExistingPostID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExistingPostID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
